...
echo ============================================================
echo Spaceship Titanic ML Workshop - CPU run
echo ============================================================
...
set "LOG_FILE=outputs\logs\run_cpu.log"
echo [info] Console log will also be saved to %LOG_FILE%
echo.

powershell -NoProfile -ExecutionPolicy Bypass -Command "& { & '%PYTHON_EXE%' %PYTHON_ARGS% -u 'src\spaceship_raw_trio_groupaware_retrain.py' --threads 8 --xgb-device cpu --apply-residual-stage --strict-candidates 2>&1 | Tee-Object -FilePath '%LOG_FILE%'; exit $LASTEXITCODE }"
