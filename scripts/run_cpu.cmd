...
powershell -NoProfile -ExecutionPolicy Bypass -Command "& { & '%PYTHON_EXE%' -u 'src\spaceship_raw_trio_groupaware_retrain.py' --threads 8 --xgb-device cpu --apply-residual-stage --strict-candidates 2>&1 | Tee-Object -FilePath '%LOG_FILE%'; exit $LASTEXITCODE }"
